package sunnyweather.rokuan.com.sunny.appwidget;
 ...
 */
public class SunnyAppWidget extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i=0; i<N; i++) {
            ...
            views.setOnClickPendingIntent(R.id.weather_card, pendingIntent);
